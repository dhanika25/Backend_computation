...
import Backtesting.data_retriever_util as dr
import Backtesting.utils as btutil
...
# Parameters for CMF strategy
stop_loss_percentage = 0.05
toPlot = True

# Apply CMF strategy
result = st.implement_cmf(df, stop_loss_percentage, toPlot)
